...
# 分组的ps文件
metadata2 = read.delim("C:/Matrine_part_I/result/ggclusternet/metadata.txt",row.names = 1)
otutab2 = read.delim("C:/Matrine_part_I/result/ggclusternet/otutab.txt", row.names=1)
taxonomy2 = read.table("C:/Matrine_part_I/result/ggclusternet/taxonomy.txt", row.names=1,header = T)
...
path_1 = "C:/Matrine_part_I/result/ggclusternet/imitate/"
dir.create(path_1)
# 作为一个data.frame，出现，。
write.table(otu_table,file = "C:/Matrine_part_I/result/ggclusternet/imitate/otu_table_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
...
tax_table = ps_net %>%
  vegan_tax() %>%
  as.data.frame()
write.table(tax_table,file = "C:/Matrine_part_I/result/ggclusternet/imitate/tax_table_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
...
po1
ggsave("C:/Matrine_part_I/result/ggclusternet/imitate/8group_cs1_new.pdf",po1,width = 8,height = 6)
```
...
ggsave("C:/Matrine_part_I/result/ggclusternet/imitate/1group_cs2_new.pdf",pnet1,width = 7,height = 5.5)
...
ggsave("C:/Matrine_part_I/result/ggclusternet/imitate/7group_cs3.pdf",pnet2,width = 7,height = 5.5)
...
path_2 = "C:/Matrine_part_I/result/ggclusternet/species_class/"
dir.create(path_2)
...
tax
dir.create("C:/Matrine_part_I/result/ggclusternet/species_class/")
write.table(tax,file = "C:/Matrine_part_I/result/ggclusternet/species_class/tax_with_filed_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
...
ggsave("C:/Matrine_part_I/result/ggclusternet/species_class/raw_group_Phylum_cs1_new.pdf",pnet3,width = 7,height = 5.5)
...
ggsave("C:/Matrine_part_I/result/ggclusternet/species_class/optimize1_group_cs2_new.pdf",pnet4,width = 7,height = 5.5)
```
...
ggsave("C:/Matrine_part_I/result/ggclusternet/species_class/optimize2_group_cs3_new.pdf",pnet5,width = 7,height = 5.5)
```
...
ggsave("C:/Matrine_part_I/result/ggclusternet/species_class/optimize3_maptree_group_cs4_new.pdf",pnet6,width = 7,height = 5.5)
```
...
path_3 = "C:/Matrine_part_I/result/ggclusternet/net_model/"
dir.create(path_3)
# result2 = PolygonRrClusterG (cor = cor,nodeGroup =group2 )
node = result2[[1]]
...
write.table(nodes2,file = "C:/Matrine_part_I/result/ggclusternet/net_model/tax_with_model_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
...
ggsave("C:/Matrine_part_I/result/ggclusternet/net_model/model_maptree_group_cs1_new.pdf",pnet7,width = 7,height = 5.5)
```
...
ggsave("C:/Matrine_part_I/result/ggclusternet/net_model/model_maptree2_group_cs2_new.pdf",pnet8,width = 7,height = 5.5)
...
path_4 = "C:/Matrine_part_I/result/ggclusternet/igraphi/"
dir.create(path_4)
...
write.table(dat,file = "C:/Matrine_part_I/result/ggclusternet/igraphi/tax_with_modelname_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
write.table(tem,file = "C:/Matrine_part_I/result/ggclusternet/igraphi/tax_with_color_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
...
nodes = nodeadd(plotcord =node,otu_table = otu_table,tax_table = tax_table)
head(nodes)
write.table(nodes,file = "C:/Matrine_part_I/result/ggclusternet/igraphi/nodes_with_class_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
#-----计算边#--------
edge = edgeBuild(cor = cor,node = node)
colnames(edge)[8] = "cor"
head(edge)
...
ggsave("C:/Matrine_part_I/result/ggclusternet/igraphi/igraphi_cs1_new.pdf",plo1,width = 12,height = 10)
...
```{R}
path_5 = "C:/Matrine_part_I/result/ggclusternet/net_node_features/"
dir.create(path_5)
...
head(dat1)
write.table(dat1,file = "C:/Matrine_part_I/result/ggclusternet/net_node_features/net_feature1_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)

# 升级后包含的网络属性更多, n.hub中T不行跑不出来，F可以
dat2 = net_properties.2(igraph,n.hub = F)
head(dat2,n = 16)
write.table(dat2,file = "C:/Matrine_part_I/result/ggclusternet/net_node_features/net_feature2_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)

dat3 = net_properties.3(igraph,n.hub = F)
head(dat3,n = 16)
write.table(dat3,file = "C:/Matrine_part_I/result/ggclusternet/net_node_features/net_feature3_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)

# 增加了网络模块性（modularity.net ）和随机网络模块性（modularity_random ）
dat4 = net_properties.4(igraph,n.hub = F)
head(dat4,n = 16)

write.table(dat4,file = "C:/Matrine_part_I/result/ggclusternet/net_node_features/net_feature4_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
...
head(nodepro)
write.table(nodepro,file = "C:/Matrine_part_I/result/ggclusternet/net_node_features/nodes_feature_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
...
pA
dataNN <- res[[2]]
write.table(dataNN,file = "C:/Matrine_part_I/result/ggclusternet/net_node_features/zipi_data_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
ggsave("C:/Matrine_part_I/result/ggclusternet/net_node_features/zipi_classfication_new.pdf",pA,width = 8,height = 7)
...
ggsave("C:/Matrine_part_I/result/ggclusternet/net_node_features/top_keystone_micro_new.pdf",width = 5,height = 4)
...
write.table(sum_net,file = "C:/Matrine_part_I/result/ggclusternet/net_node_features/sum_net_compare_new.txt",quote = F,sep = '\t', row.names = T, col.names = T)
ggsave("C:/Matrine_part_I/result/ggclusternet/net_node_features/randomnet_net_compare_new.pdf",ppnet,width = 5,height = 4)
```
...
path = "C:/Matrine_part_I/result/ggclusternet/result_micro_200/"
dir.create(path)
...
path = "C:/Matrine_part_I/result/ggclusternet/result_big_1000/"
dir.create(path)
...
path = "C:/Matrine_part_I/result/ggclusternet/result_1000_igraph/"
dir.create(path)
# map = sample_data(ps)
# map$Group = "one"
...
```{R,fig.width = 12,fig.height = 6}
path = "C:/Matrine_part_I/result/ggclusternet/result_igraph2_500_new/"
dir.create(path)
...
path_6 = "C:/Matrine_part_I/result/ggclusternet/net_stable/"
dir.create(path_6)

write.table(datstable2,file = "C:/Matrine_part_I/result/ggclusternet/net_stable/simility.txt",quote = F,sep = '\t', row.names = T, col.names = T)
write.table(datstable,file = "C:/Matrine_part_I/result/ggclusternet/net_stable/simility2.txt",quote = F,sep = '\t', row.names = T, col.names = T)
ggsave("C:/Matrine_part_I/result/ggclusternet/net_stable/simility.pdf",pstable,width = 8,height = 7)
...
write.table(dats3,file = "C:/Matrine_part_I/result/ggclusternet/net_stable/robustness.txt",quote = F,sep = '\t', row.names = T, col.names = T)
ggsave("C:/Matrine_part_I/result/ggclusternet/net_stable/robustness.pdf",pstable3,width = 16,height = 7)
```
...
write.table(dat,file = "C:/Matrine_part_I/result/ggclusternet/net_stable/robustness_keynode.txt",quote = F,sep = '\t', row.names = T, col.names = T)
ggsave("C:/Matrine_part_I/result/ggclusternet/net_stable/robustness_keynode.pdf",p,width = 16,height = 7)
```
