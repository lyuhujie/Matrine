...
if ("pdf" == "png") {
    png(filename="result/alpha/otu_group_exist.txt.MDA_MDB_MDC.vennDiagram.png", width=3, height=3,
        res=300, units="cm")
} else if ("pdf" == "eps") {
    postscript(file="result/alpha/otu_group_exist.txt.MDA_MDB_MDC.vennDiagram.eps", onefile=FALSE, horizontal=FALSE,
               paper="special", width=10, height = 12, pointsize=10)
} else if ("pdf" == "pdf") {
    pdf(file="result/alpha/otu_group_exist.txt.MDA_MDB_MDC.vennDiagram.pdf", width=3, height=3)
}else if ("pdf" == "svg") {
    svg(filename="result/alpha/otu_group_exist.txt.MDA_MDB_MDC.vennDiagram.svg", width=3, height=3,
        pointsize=10)
} else {
